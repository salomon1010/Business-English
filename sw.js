...
const SHELL = ["./", "index.html", "manifest.json", "logo.svg", "icon-192.png", "icon-512.png",
  "jurisdictions.js?v=9", "trades.js?v=9", "curriculum-provider.js?v=9", "professional-tracks.js?v=9", "competency-engine.js?v=9", "learning-coach.js?v=9",
  "professional-simulation-engine.js?v=9", "conversation-orchestrator.js?v=9", "adaptive-learning-engine.js?v=9",
  "career-center.js?v=9", "professional-skills-passport.js?v=9", "answer-evaluator.js?v=9",
