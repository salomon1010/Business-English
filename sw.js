...
const SHELL = ["./", "index.html", "manifest.json", "logo.svg", "icon-192.png", "icon-512.png",
  "jurisdictions.js?v=6", "trades.js?v=6", "curriculum-provider.js?v=6", "professional-tracks.js?v=6", "competency-engine.js?v=6", "learning-coach.js?v=6",
  "professional-simulation-engine.js?v=6", "conversation-orchestrator.js?v=6", "adaptive-learning-engine.js?v=6",
  "career-center.js?v=6", "professional-skills-passport.js?v=6", "answer-evaluator.js?v=6",
