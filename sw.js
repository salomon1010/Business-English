...
const SHELL = ["./", "index.html", "manifest.json", "logo.svg", "icon-192.png", "icon-512.png",
  "jurisdictions.js?v=5", "curriculum-provider.js?v=5", "professional-tracks.js?v=5", "competency-engine.js?v=5", "learning-coach.js?v=5",
  "professional-simulation-engine.js?v=5", "conversation-orchestrator.js?v=5", "adaptive-learning-engine.js?v=5",
  "career-center.js?v=5", "professional-skills-passport.js?v=5", "answer-evaluator.js?v=5",
