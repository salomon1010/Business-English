...
const SHELL = ["./", "index.html", "manifest.json", "logo.svg", "icon-192.png", "icon-512.png",
  "jurisdictions.js?v=4", "curriculum-provider.js?v=4", "professional-tracks.js?v=4", "competency-engine.js?v=4", "learning-coach.js?v=4",
  "professional-simulation-engine.js?v=4", "conversation-orchestrator.js?v=4", "adaptive-learning-engine.js?v=4",
  "career-center.js?v=4", "professional-skills-passport.js?v=4", "answer-evaluator.js?v=4",
