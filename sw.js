...
const SHELL = ["./", "index.html", "manifest.json", "logo.svg", "icon-192.png", "icon-512.png",
  "jurisdictions.js?v=7", "trades.js?v=7", "curriculum-provider.js?v=7", "professional-tracks.js?v=7", "competency-engine.js?v=7", "learning-coach.js?v=7",
  "professional-simulation-engine.js?v=7", "conversation-orchestrator.js?v=7", "adaptive-learning-engine.js?v=7",
  "career-center.js?v=7", "professional-skills-passport.js?v=7", "answer-evaluator.js?v=7",
