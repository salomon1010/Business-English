...
ok("N1 · A fresh learner's Home shows no V2 card on Home (removed 2026-09-24 — the mission opens from the session page) — Week 11 does not appear prematurely",
...
for (const c of LATER) {
  ...
  ok(`R3 · With everything before it resting, ${c.id} (Week ${c.week}) rests through the engine to transfer-ready, and Home still shows no V2 card on Home (removed 2026-09-24 — the mission opens from the session page)`, step.offered === "" && step.state === "TRANSFER_READY", JSON.stringify(step));
}
