...
ok("K1 · A fresh learner's Home shows no V2 card on Home (removed 2026-09-24 — the mission opens from the session page) — Week 6 does not appear prematurely",
...
ok("SEE renders Week 6's title, the project lead's question and the goal, with one action and a way back — and is worth INTRODUCED only",
  /Recommendations & decision language/i.test(see.txt) && /three weeks late/i.test(see.txt) && /What do you recommend/i.test(see.txt) && /Mission Hear Notice Speak Coach Complete/.test(see.txt) && see.cta === 1 && see.back && see.state === "INTRODUCED", see.txt.slice(0, 160));
