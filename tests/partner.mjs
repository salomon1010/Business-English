...
ok("Floating 'Talk to a real person' button on Road map: visible, above the bottom nav", fab.on && fab.txt === (await A.page.evaluate(() => t("pp.fab_small") !== "pp.fab_small" ? t("pp.fab_small") : t("pp.fab"))) && fab.clearOfNav && fab.right, JSON.stringify(fab));
